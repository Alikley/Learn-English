...
export const MEMORY_WORDS: MemoryWordData[] = [
  ...
  // ---- افزودنی‌های v1.0.0.6 — تنوع بیشتر برای سطح آسان ----
  // ---- حیوانات ----
  { word: "tiger", translation: "ببر", category: "animals", level: "EASY", cefr: "A1" },
  { word: "mouse", translation: "موش", category: "animals", level: "EASY", cefr: "A1" },
  { word: "snake", translation: "مار", category: "animals", level: "EASY", cefr: "A1" },
  { word: "cow", translation: "گاو", category: "animals", level: "EASY", cefr: "A1" },
  { word: "pig", translation: "خوک", category: "animals", level: "EASY", cefr: "A1" },
  { word: "goat", translation: "بز", category: "animals", level: "EASY", cefr: "A1" },
  { word: "bee", translation: "زنبور", category: "animals", level: "EASY", cefr: "A1" },
  { word: "ant", translation: "مورچه", category: "animals", level: "EASY", cefr: "A1" },
  { word: "spider", translation: "عنکبوت", category: "animals", level: "EASY", cefr: "A1" },
  { word: "fox", translation: "روباه", category: "animals", level: "EASY", cefr: "A1" },
  { word: "deer", translation: "آهو", category: "animals", level: "EASY", cefr: "A1" },
  { word: "camel", translation: "شتر", category: "animals", level: "EASY", cefr: "A1" },
  { word: "donkey", translation: "الاغ", category: "animals", level: "EASY", cefr: "A1" },

  // ---- خوراکی‌ها ----
  { word: "honey", translation: "عسل", category: "food", level: "EASY", cefr: "A1" },
  { word: "sugar", translation: "شکر", category: "food", level: "EASY", cefr: "A1" },
  { word: "juice", translation: "آبمیوه", category: "food", level: "EASY", cefr: "A1" },
  { word: "cookie", translation: "کوکی", category: "food", level: "EASY", cefr: "A1" },
  { word: "candy", translation: "آب‌نبات", category: "food", level: "EASY", cefr: "A1" },
  { word: "grape", translation: "انگور", category: "food", level: "EASY", cefr: "A1" },
  { word: "peach", translation: "هلو", category: "food", level: "EASY", cefr: "A1" },
  { word: "cherry", translation: "آلبالو", category: "food", level: "EASY", cefr: "A1" },
  { word: "lemon", translation: "لیمو", category: "food", level: "EASY", cefr: "A1" },
  { word: "tomato", translation: "گوجه", category: "food", level: "EASY", cefr: "A1" },
  { word: "onion", translation: "پیاز", category: "food", level: "EASY", cefr: "A1" },
  { word: "carrot", translation: "هویج", category: "food", level: "EASY", cefr: "A1" },

  // ---- خانواده / مدرسه ----
  { word: "uncle", translation: "عمو", category: "family", level: "EASY", cefr: "A1" },
  { word: "ruler", translation: "خط‌کش", category: "school", level: "EASY", cefr: "A1" },
  { word: "chalk", translation: "گچ", category: "school", level: "EASY", cefr: "A1" },

  // ---- طبیعت و آب‌وهوا ----
  { word: "leaf", translation: "برگ", category: "nature", level: "EASY", cefr: "A1" },
  { word: "lake", translation: "دریاچه", category: "nature", level: "EASY", cefr: "A1" },
  { word: "sand", translation: "شن", category: "nature", level: "EASY", cefr: "A1" },
  { word: "cloud", translation: "ابر", category: "weather", level: "EASY", cefr: "A1" },

  // ---- بدن ----
  { word: "lip", translation: "لب", category: "body", level: "EASY", cefr: "A1" },
  { word: "knee", translation: "زانو", category: "body", level: "EASY", cefr: "A1" },
  { word: "bone", translation: "استخوان", category: "body", level: "EASY", cefr: "A1" },

  // ---- خانه ----
  { word: "lamp", translation: "چراغ", category: "house", level: "EASY", cefr: "A1" },
  { word: "fork", translation: "چنگال", category: "house", level: "EASY", cefr: "A1" },
  { word: "spoon", translation: "قاشق", category: "house", level: "EASY", cefr: "A1" },
  { word: "plate", translation: "بشقاب", category: "house", level: "EASY", cefr: "A1" },

  // ---- لباس / زمان / عمومی / جشن‌ها ----
  { word: "hat", translation: "کلاه", category: "clothes", level: "EASY", cefr: "A1" },
  { word: "sock", translation: "جوراب", category: "clothes", level: "EASY", cefr: "A1" },
  { word: "boot", translation: "چکمه", category: "clothes", level: "EASY", cefr: "A1" },
  { word: "noon", translation: "ظهر", category: "time", level: "EASY", cefr: "A1" },
  { word: "boy", translation: "پسر", category: "general", level: "EASY", cefr: "A1" },
  { word: "gift", translation: "هدیه", category: "celebration", level: "EASY", cefr: "A1" },
  ...
  // ---- افزودنی‌های v1.0.0.6 — تنوع بیشتر برای سطح متوسط ----
  // ---- افعال پرکاربرد A2 ----
  { word: "accept", translation: "پذیرفتن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "advise", translation: "توصیه کردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "argue", translation: "بحث کردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "arrive", translation: "رسیدن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "borrow", translation: "قرض گرفتن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "cancel", translation: "لغو کردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "carry", translation: "حمل کردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "cause", translation: "باعث شدن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "climb", translation: "بالا رفتن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "complain", translation: "شکایت کردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "create", translation: "ایجاد کردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "decide", translation: "تصمیم گرفتن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "deliver", translation: "تحویل دادن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "depend", translation: "وابسته بودن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "earn", translation: "کسب کردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "enjoy", translation: "لذت بردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "escape", translation: "فرار کردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "explain", translation: "توضیح دادن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "forgive", translation: "بخشیدن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "gather", translation: "گردآوردن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "join", translation: "پیوستن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "offer", translation: "پیشنهاد دادن", category: "general", level: "MEDIUM", cefr: "A2" },
  { word: "promise", translation: "قول دادن", category: "general", level: "MEDIUM", cefr: "A2" },

  // ---- افعال و واژه‌های B1 ----
  { word: "challenge", translation: "چالش", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "compare", translation: "مقایسه کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "compete", translation: "رقابت کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "curious", translation: "کنجکاو", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "destroy", translation: "نابود کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "develop", translation: "توسعه دادن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "discover", translation: "کشف کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "divide", translation: "تقسیم کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "examine", translation: "بررسی کردن", category: "school", level: "MEDIUM", cefr: "B1" },
  { word: "expect", translation: "انتظار داشتن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "explore", translation: "کاوش کردن", category: "nature", level: "MEDIUM", cefr: "B1" },
  { word: "guarantee", translation: "تضمین", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "imagine", translation: "تصور کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "improve", translation: "بهبود دادن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "include", translation: "شامل بودن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "increase", translation: "افزایش دادن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "invite", translation: "دعوت کردن", category: "celebration", level: "MEDIUM", cefr: "A2" },
  { word: "measure", translation: "اندازه گرفتن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "mention", translation: "اشاره کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "prevent", translation: "جلوگیری کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "realize", translation: "درک کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "receive", translation: "دریافت کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "reduce", translation: "کاهش دادن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "refuse", translation: "رد کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "remind", translation: "یادآوری کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "separate", translation: "جدا کردن", category: "general", level: "MEDIUM", cefr: "B1" },
  { word: "solve", translation: "حل کردن", category: "school", level: "MEDIUM", cefr: "B1" },
  ...
  // ---- افزودنی‌های v1.0.0.6 — تنوع بیشتر برای سطح سخت ----
  // ---- واژه‌های آموزشی و روزمره سطح B2 ----
  { word: "anxiety", translation: "اضطراب", category: "health", level: "HARD", cefr: "B2" },
  { word: "apologize", translation: "عذرخواهی کردن", category: "character", level: "HARD", cefr: "B2" },
  { word: "apparent", translation: "بدیهی", category: "general", level: "HARD", cefr: "B2" },
  { word: "approach", translation: "رویکرد", category: "academic", level: "HARD", cefr: "B2" },
  { word: "approve", translation: "تأیید کردن", category: "work", level: "HARD", cefr: "B2" },
  { word: "artificial", translation: "مصنوعی", category: "environment", level: "HARD", cefr: "B2" },
  { word: "assess", translation: "سنجیدن", category: "academic", level: "HARD", cefr: "B2" },
  { word: "attitude", translation: "نگرش", category: "character", level: "HARD", cefr: "B2" },
  { word: "attract", translation: "جذب کردن", category: "general", level: "HARD", cefr: "B2" },
  { word: "authentic", translation: "حقیقی", category: "general", level: "HARD", cefr: "B2" },
  { word: "available", translation: "در دسترس", category: "general", level: "HARD", cefr: "B2" },
  { word: "barrier", translation: "سد", category: "general", level: "HARD", cefr: "B2" },
  { word: "betray", translation: "خیانت کردن", category: "character", level: "HARD", cefr: "B2" },
  { word: "candidate", translation: "نامزد", category: "work", level: "HARD", cefr: "B2" },
  { word: "capacity", translation: "ظرفیت", category: "academic", level: "HARD", cefr: "B2" },
  { word: "collapse", translation: "فروریختن", category: "general", level: "HARD", cefr: "B2" },
  { word: "coincidence", translation: "هم‌زمانی", category: "general", level: "HARD", cefr: "B2" },
  { word: "collaborate", translation: "همکاری کردن", category: "work", level: "HARD", cefr: "B2" },
  { word: "commit", translation: "مرتکب شدن", category: "general", level: "HARD", cefr: "B2" },
  { word: "comprehensive", translation: "جامع", category: "academic", level: "HARD", cefr: "B2" },
  { word: "confront", translation: "مواجه شدن", category: "character", level: "HARD", cefr: "B2" },
  { word: "congratulate", translation: "تبریک گفتن", category: "celebration", level: "HARD", cefr: "B2" },
  { word: "conscience", translation: "وجدان", category: "character", level: "HARD", cefr: "B2" },
  { word: "consistent", translation: "سازگار", category: "general", level: "HARD", cefr: "B2" },
  { word: "consult", translation: "مشورت کردن", category: "work", level: "HARD", cefr: "B2" },
  { word: "controversy", translation: "مناقشه", category: "general", level: "HARD", cefr: "B2" },
  { word: "correspond", translation: "مکاتبه کردن", category: "work", level: "HARD", cefr: "B2" },
  { word: "crucial", translation: "حیاتی", category: "academic", level: "HARD", cefr: "B2" },
  { word: "deadline", translation: "مهلت", category: "work", level: "HARD", cefr: "B2" },
  { word: "deceive", translation: "فریب دادن", category: "character", level: "HARD", cefr: "B2" },
  { word: "decline", translation: "افول کردن", category: "general", level: "HARD", cefr: "B2" },
  { word: "dedicate", translation: "وقف کردن", category: "work", level: "HARD", cefr: "B2" },
  { word: "deny", translation: "انکار کردن", category: "character", level: "HARD", cefr: "B2" },
  { word: "desperate", translation: "ناامید", category: "feelings", level: "HARD", cefr: "B2" },
  { word: "determine", translation: "تعیین کردن", category: "general", level: "HARD", cefr: "B2" },
  { word: "dilemma", translation: "دوراهی", category: "general", level: "HARD", cefr: "B2" },
  { word: "diminish", translation: "کوچک شدن", category: "academic", level: "HARD", cefr: "B2" },
  { word: "disclose", translation: "افشا کردن", category: "general", level: "HARD", cefr: "B2" },
  { word: "dismiss", translation: "برکنار کردن", category: "work", level: "HARD", cefr: "B2" },
  { word: "distinguish", translation: "تمایز قائل شدن", category: "academic", level: "HARD", cefr: "B2" },
  { word: "dominate", translation: "سلطه داشتن", category: "general", level: "HARD", cefr: "B2" },
  { word: "doubt", translation: "شک", category: "feelings", level: "HARD", cefr: "B2" },
  { word: "dramatic", translation: "دراماتیک", category: "general", level: "HARD", cefr: "B2" },
  { word: "eliminate", translation: "از میان بردن", category: "general", level: "HARD", cefr: "B2" },
  { word: "emerge", translation: "ظاهر شدن", category: "general", level: "HARD", cefr: "B2" },
  { word: "endeavor", translation: "کوشش", category: "work", level: "HARD", cefr: "B2" },
  { word: "enhance", translation: "ارتقا دادن", category: "academic", level: "HARD", cefr: "B2" },
  { word: "ensure", translation: "اطمینان دادن", category: "general", level: "HARD", cefr: "B2" },
  { word: "equivalent", translation: "معادل", category: "academic", level: "HARD", cefr: "B2" },
  { word: "establish", translation: "برقرار کردن", category: "work", level: "HARD", cefr: "B2" },
  { word: "estimate", translation: "تخمین زدن", category: "academic", level: "HARD", cefr: "B2" },
  { word: "evolve", translation: "تکامل یافتن", category: "nature", level: "HARD", cefr: "B2" },
  { word: "exceed", translation: "فراتر رفتن", category: "academic", level: "HARD", cefr: "B2" },
  { word: "explicit", translation: "صریح", category: "academic", level: "HARD", cefr: "B2" },
  { word: "extensive", translation: "گسترده", category: "academic", level: "HARD", cefr: "B2" },
  { word: "fatigue", translation: "فرسودگی", category: "health", level: "HARD", cefr: "B2" },
  { word: "flexible", translation: "منعطف", category: "character", level: "HARD", cefr: "B2" },
  { word: "forbid", translation: "ممنوع کردن", category: "general", level: "HARD", cefr: "B2" },
  { word: "furious", translation: "خشمگین", category: "feelings", level: "HARD", cefr: "B2" },
  { word: "gradual", translation: "تدریجی", category: "academic", level: "HARD", cefr: "B2" },
  { word: "hesitate", translation: "تردید کردن", category: "character", level: "HARD", cefr: "B2" },
  { word: "hypothesis", translation: "فرضیه", category: "academic", level: "HARD", cefr: "B2" },

  // ---- افزودنی‌های خیلی پیشرفته — سطح C1 ----
  { word: "extraordinary", translation: "خارق‌العاده", category: "general", level: "HARD", cefr: "C1" },
  { word: "facilitate", translation: "تسهیل کردن", category: "academic", level: "HARD", cefr: "C1" },
  { word: "fluctuate", translation: "نوسان داشتن", category: "academic", level: "HARD", cefr: "C1" },
];
