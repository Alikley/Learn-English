// ========================================
// لغت‌نامهٔ محلی آفلاین — 680 مدخل یکتا (نسخه ۱.۰.۲.۹)
// منابع: درس‌های واژگان (۳۰۰، اولویت سطح بالاتر) + بازی حافظه (382) + کوییز سرعتی (180)
// استفاده: POST /api/vocabulary/translate (بدون نیاز به ورود) + افزودن کلمه به جعبه
// بازتولید: node scripts/gen-local-dictionary.mjs <tree-root>
// ========================================

/** واژه انگلیسی (حروف کوچک) → معنی فارسی */
...
export const localDictionarySize = Object.keys(LOCAL_DICTIONARY).length;

/**
 * جست‌وجوی معنی فارسی یک کلمه انگلیسی در لغت‌نامهٔ محلی.
 * کلمه را نرمال می‌کند (حذف فاصله + حروف کوچک)؛ اگر پیدا نشد null.
 */
