// ========================================
// لغت‌نامه محلی آفلاین — ترجمه فارسی کلمات پرکاربرد
// منبع: درس‌های واژگان + کلمات بازی حافظه + کلمات کوییز سرعتی
// نسخه ۱.۰.۲.۷ — بدون وابستگی به دیتابیس یا سرویس بیرونی
// ========================================

/** تعداد مدخل‌های لغت‌نامه محلی */
export const localDictionarySize = 680;
...
/**
 * جستجوی ترجمه محلی یک کلمه انگلیسی.
 * ورودی باید lower-case و تک‌کلمه باشد؛ خروجی null یعنی «ناشناخته».
 */
