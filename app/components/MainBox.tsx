        ...
        <div className="relative z-10 flex flex-col md:flex-row h-full pt-4 md:pt-0">
          ...
          <div className="flex-1 flex items-center justify-center mt-2 md:mt-0">
            <div className="flex flex-col items-center md:items-end text-center md:text-right px-2 md:px-0 max-w-[95%]">
              <h1 className="text-[22px] sm:text-[26px] md:text-[48px] leading-snug md:leading-none font-bold text-slate-900 break-words">
                <span>!خوش آمدید</span>{" "}
                <span className="text-blue-600">flex English</span>{" "}
                <span>به</span>{" "}
              </h1>

              <p className="mt-2 sm:mt-3 text-[14px] sm:text-[16px] md:text-[20px] text-slate-600 max-w-[90%] md:max-w-xl break-words">
