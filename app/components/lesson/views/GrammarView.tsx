...
const STEPS = ["آموزش", "مثال‌ها", "اشتباهات رایج", "آزمونک"];
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 0 && (
          ...
          >
            ...
            <motion.div
              ...
              className="bg-gradient-to-l from-blue-50 to-white border border-blue-200 rounded-2xl p-4 shadow-sm"
            >
              <div className="flex items-center gap-2 mb-2">
                <span className="w-8 h-8 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center">
                  <BookOpen size={18} />
                </span>
                <h3 className="font-bold text-slate-900">قانون گرامری</h3>
              </div>
              <p className="text-slate-700 text-sm leading-8">{lesson.rule}</p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-bold text-slate-900">ساختار جمله</h3>
              </div>
        ...
        {step === 2 && (
          ...
          >
            ...
            <ContinueButton onClick={() => setStep(3)} label="شروع آزمونک" />
          </motion.div>
        )}
