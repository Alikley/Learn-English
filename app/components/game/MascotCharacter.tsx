...
// ========================================
// کاراکتر انسان متحرک صفحه بازی‌ها — v1.0.0.8
//
...
//  - شناوری آرام (idle float) + ورود فنری
//
// منطق در هوک‌هاست؛ این کامپوننت فقط رندر و انیمیشن است.
// پس‌زمینه صفحه تغییری نمی‌کند — فقط خود کاراکتر اضافه می‌شود.
// ========================================
...
export default function MascotCharacter() {
  ...
  return (
    <motion.div
      ref={ref}
      // ورود فنری + شناوری آرام بی‌نهایت
      ...
      className="w-full max-w-[270px] mx-auto select-none pointer-events-none"
      aria-label="کاراکتر راهنمای بازی‌ها"
      role="img"
    >
      <svg viewBox="0 0 300 400" className="w-full h-auto drop-shadow-sm">
        <defs>
